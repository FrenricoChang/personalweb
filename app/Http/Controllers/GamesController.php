...
class GamesController extends Controller
{
    public function index(String $name){
        $games = [
            ['name' => 'Dota2', 'type' => 'MOBA', 'playtime' =>'211.3 hrs', 'id' => '1', 'description' => 'Dota 2 is a multiplayer game where two teams of five players battle to destroy each others base. Players select heroes with unique abilities and work together to level up and earn gold to buy items that enhance their abilities. The game is known for its depth and competitiveness.', 'Img' => 'Dota 2.png'],
